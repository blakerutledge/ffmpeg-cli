...
const allOS = {
	...
	win32: {
		x32: {
			...
			probePath: rootDir + '/ffmpeg/win32x32/bin/ffprobe.exe'
		},
		x64: {
			...
			probePath: rootDir + '/ffmpeg/win32x64/bin/ffprobe.exe'
		}
	}
}
...
module.exports.probePath = path.normalize(module.exports.probePath);